...
namespace CityOrders.Api.Migrations
{
    ...
    [Migration("20260528090822_AddDeliveryPlansAndRequests")]
    partial class AddDeliveryPlansAndRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CityOrders.Api.Domain.Entities.DeliveryPaymentRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AgentUserId", "Status");

                    b.ToTable("DeliveryPaymentRequests");
                });

            modelBuilder.Entity("CityOrders.Api.Domain.Entities.DeliveryPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 28, 9, 8, 21, 692, DateTimeKind.Utc).AddTicks(1535),
                            Description = "Settle your cash balance weekly for a flat fee.",
                            DurationDays = 7,
                            IsEnabled = true,
                            Name = "Weekly Settlement Plan",
                            PriceEgp = 150m
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 28, 9, 8, 21, 692, DateTimeKind.Utc).AddTicks(3283),
                            Description = "Settle your cash balance monthly for a discounted flat fee.",
                            DurationDays = 30,
                            IsEnabled = true,
                            Name = "Monthly Settlement Plan",
                            PriceEgp = 500m
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 28, 9, 8, 21, 692, DateTimeKind.Utc).AddTicks(3287),
                            Description = "Manual custom settlement option.",
                            DurationDays = 1,
                            IsEnabled = true,
                            Name = "Custom Settlement Plan",
                            PriceEgp = 0m
                        });
                });
            ...
            modelBuilder.Entity("CityOrders.Api.Domain.Entities.DeliveryPaymentRequest", b =>
                {
                    ...
                    b.HasOne("CityOrders.Api.Domain.Entities.DeliveryPlan", "Plan")
